...
<div class="row">	
<div class="display-4 col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1 text-center"> <br>	<br>	<br>	</div>
...
<div class="display-6 col-6 col-sm-6 col-md-6 col-lg-12 col-xl-2 text-center">	
...
//Creo una variable booleana (bandera) para saber cuando se requiere el ruteo 
	...
	//	mymap.flyTo([3.372472, -76.533229], 16);
		alert( "A continuación se muestran todas las noticias reportadas" );
	  	//Cambio de estado la vabriable bandera
	  	cargarCluster();
